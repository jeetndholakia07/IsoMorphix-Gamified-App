...
const Toaster: FC<ToastProps> = ({ show, onClose, type = 'info', heading, message }) => {
    if (!show) return null;
    ...
    return (
        <div className="fixed top-4 right-4 z-50 flex flex-col space-y-4">
            <div
                ...
                ${toastStyles[type]} border-2 border-opacity-80 transform transition-all duration-300 ease-in-out
